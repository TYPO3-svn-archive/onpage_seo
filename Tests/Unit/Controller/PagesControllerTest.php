...
/**
 * Test case for class Tx_Onpage_seo_Controller_PagesController.
 *
 * @version $Id$
 ...
 */
class Tx_Onpage_seo_Controller_PagesControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
