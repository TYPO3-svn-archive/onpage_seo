...
$tmp_onpage_seo_columns = array(
    ...
    'gplusdesc' => array(
        'exclude' => 0,
        'label' => 'LLL:EXT:onpage_seo/Resources/Private/Language/locallang_db.xml:tx_onpageseo_domain_model_page.gplusdesc',
        'config' => array(
            'type' => 'text',
            'cols' => 40,
            'rows' => 15,
...
// Important add!
t3lib_extMgm::addToAllTCAtypes('pages', 'keywordlist, fbdesc, fbimage, gplusdesc', '', 'after: description');
...
$TCA['pages']['types']['Tx_OnpageSeo_Page']['showitem'] .= 'fbimage, fbdesc, gplusdesc, keywordlist';
